...
import { Text, View, StyleSheet, Picker, Alert, Switch, Button, Modal } from 'react-native';
...
class Reservation extends Component {
    ...
    handleReservation() {
        ...
        let x = this.state.smoking ? 'true' : 'false';
        Alert.alert(
            'Your Reservation OK?',
    ...
    async addReservationToCalendar(date) {
        ...
        await Calendar.createEventAsync(this.obtainDefaultCalendarId(), {
